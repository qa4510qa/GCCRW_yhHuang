...
def main(argv):
    ...
    SDInitial = {'ShiMen Reservoir':argv[0], # 205588000
                'ZhongZhuang Adjustment Reservoir':argv[1], # 5050000
                'ShiMen WPP Storage Pool':argv[2]} # 500000
    ...
    # Note:
        ...
        # Good luck!
    # print(SDResultDict['ShiMen Reservoir'])
    # print(SDResult['ShiMen Reservoir'][-1:])
    # print(SDResult['ZhongZhuang Adjustment Reservoir'][-1:])
